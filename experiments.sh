...
-k 15 -method GCN_KNN | tee -a GCN_KNN.txt
...
-half_val_as_train 0  -hidden 32  -knn_metric cosine -lr 0.01 -nlayers 2 \
-normalization sym  -ntrials 5  -patience 3000  -sparse 0 -w_decay 0.0005 \
-k 15  -alpha 100 -klabel 30 -method GCN_KNN_U | tee -a GCN_KNN_U.txt
...
-half_val_as_train 0  -hidden 32  -knn_metric cosine -lr 0.01 -nlayers 2 \
-normalization sym  -ntrials 5  -patience 3000  -sparse 0 -w_decay 0.0005 \
-k 15  -alpha 100 -klabel 30 -method GCN_KNN_R | tee -a GCN_KNN_R.txt